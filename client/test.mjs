...
${flagLines(`-y`, a.keys(s.ALLOWED_STAT_TYPE_FILTERS))}
...
missing -a, consider using a preset such as -p=dmg`,
  ...
  test(
    ...
    },
    {
      ...
      userCurrent: true, runLatest: true,
      where: {ent_type: [`bui`], stat_type: [`dmg_done`]},
      totals: [],
    },
  )
  ...
  */
  test(
    ...
    },
    {
      ...
      agg: `sum`, aggFun: u.accSum, totalFun: u.accSum,
      userCurrent: true, runLatest: true,
      where: {ent_type: [`chi`], stat_type: [`dmg_done`]},
      totals: [],
    },
  )

  fail(
    `-p=dmg ent_type=bui ent_type=bui`,
    `exactly one "ent_type=" is required unless "-z=ent_type", got "ent_type=bui ent_type=bui"`,
  )

  fail(
    `-p=dmg ent_type=bui ent_type=chi`,
    `exactly one "ent_type=" is required unless "-z=ent_type", got "ent_type=bui ent_type=chi"`,
  )

  test(
    `plot -x=run_num -y=dmg_over -z=bui_type -a=sum ent_type=chi`,
    {
    ...
    },
    {
      X: `run_num`, Y: `dmg_over`, Z: `bui_type`,
      agg: `sum`, aggFun: u.accSum, totalFun: u.accSum,
      where: {ent_type: [`chi`], stat_type: [`dmg_over`]},
    },
  )
  ...
  test(
    `-p=dmg user_id=one`,
    {
      ...
      agg: `sum`,
      runLatest: true,
      where: {ent_type: [`bui`], user_id: [`one`]},
      totals: [],
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
  ...
  test(
    `plot -x=round_num -y=dmg_done -z=bui_type_upg -a=sum ent_type=bui user_id=current`,
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
      agg: `sum`,
      userCurrent: true,
  ...
  test(
    `-x=round_num -y=dmg_done -z=bui_type_upg -a=sum ent_type=bui run_id=12`,
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
      agg: `sum`,
      where: {ent_type: [`bui`], run_id: [`12`]},
  ...
  */
  ...
  test(
    `-p=dmg round_id=12`,
    {
      ...
      agg: `sum`,
      userCurrent: true, runLatest: true,
      where: {ent_type: [`bui`], round_id: [`12`]},
      totals: [],
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
  ...
  test(
    `-p=dmg round_id=0012`,
    {
      ...
      agg: `sum`,
      userCurrent: true, runLatest: true,
      where: {ent_type: [`bui`], round_id: [`0012`]},
      totals: [],
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
  ...
  test(
    `-p=dmg round_num=12`,
    {
      ...
      agg: `sum`,
      userCurrent: true, runLatest: true,
      where: {ent_type: [`bui`], round_num: [12]},
      totals: [],
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
  ...
  test(
    `-p=dmg bui_type=Mirador`,
    {
      ...
      agg: `sum`,
      userCurrent: true, runLatest: true,
      where: {ent_type: [`bui`], bui_type: [`CB15`]},
      totals: [],
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
  ...
  test(
    `-p=dmg bui_type_upg=Mirador`,
    {
      ...
      agg: `sum`,
      userCurrent: true, runLatest: true,
      where: {ent_type: [`bui`], bui_type_upg: [`CB15`]},
      totals: [],
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
  ...
  test(
    `-p=dmg bui_type_upg=Mirador_AAA`,
    {
      ...
      agg: `sum`,
      userCurrent: true, runLatest: true,
      where: {ent_type: [`bui`], bui_type_upg: [`CB15_AAA`]},
      totals: [],
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
  ...
  test(
    `-p=dmg frontier=18`,
    {
      ...
      agg: `sum`,
      userCurrent: true, runLatest: true,
      where: {ent_type: [`bui`], frontier: [18]},
      totals: [],
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
  ...
  test(
    `-x=round_num -y=dmg_done -z=bui_type_upg -a=sum ent_type=chi`,
    {
      X: `round_num`, Y: `dmg_done`, Z: `bui_type_upg`,
      agg: `sum`,
      where: {ent_type: [`chi`]},
  ...
  test(
    `-x=round_num -y=dmg_done -z=ent_type -a=sum ent_type=chi`,
    {
  ...
  test(
    `-x=round_num -y=dmg_done -z=ent_type -a=sum ent_type=bui ent_type=chi`,
    {
      X: `round_num`, Y: `dmg_done`, Z: `ent_type`,
      agg: `sum`,
      where: {ent_type: [`bui`, `chi`]},
    },
    {
      X: `round_num`, Y: `dmg_done`, Z: `ent_type`,
      agg: `sum`, aggFun: u.accSum, totalFun: u.accSum,
      where: {ent_type: [`bui`, `chi`], stat_type: [`dmg_done`]},
    },
  )
